...
| --- | --- | --- | --- | --- |
| [atomisthq/tools.docker](https://github.com/atomisthq/pod-atomisthq-tools.docker) | Dockerfile parsing for clojure | 0.1.0 | [link](https://github.com/atomisthq/pod-atomisthq-tools.docker/blob/main/dev/user.clj) | [<img src="https://go.dev/blog/go-brand/Go-Logo/SVG/Go-Logo_Blue.svg" alt="golang" width="24" height="24">](https://golang.org/) |
